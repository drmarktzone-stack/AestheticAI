...
export interface TranslationSchema {
  ...
  home: {
    ...
    journeyTitle: string;
    journeyPreparing: string;
    journeyTreatment: string;
    journeyRecovery: string;
    today: string;
    onTrack: string;
    exploreTitle: string;
  ...
  studio: {
    ...
    planNowTitle: string;
    planNowCopy: string;
    planNextTitle: string;
    planNextCopy: string;
    planMaintainTitle: string;
    planMaintainCopy: string;
    reviewed: string;
    reviewPlan: string;
